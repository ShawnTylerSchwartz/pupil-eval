...
import sys
sys.path.append('/Users/edslab/Desktop/Oliver/experiments/amaranthus/task_script/packages')#add this path with the extra python packages so that we can use fullfact function
sys.path.append('/Users/edslab/Desktop/Oliver/experiments/amaranthus/task_script/packages/pygaze')
sys.path.append('/Users/edslab/Desktop/Oliver/experiments/amaranthus/task_script/packages/pygaze/_eyetracker')
from pygaze import settings
settings.TRACKERSERIALNUMBER = 'TPNA1-030210214015'
import random
import constants
...
tracker = eyetracker.EyeTracker(display=disp,trackertype='tobii')
